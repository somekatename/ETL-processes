...
# -*- coding: utf-8 -*-
"""
Полный пайплайн: сбор статистик из оригинальных данных,
генерация синтетических данных (с использованием сэмплов),
расширенный статистический анализ.

Запуск: просто нажми Run в PyCharm.
Все настройки в секции "НАСТРОЙКИ".
"""
